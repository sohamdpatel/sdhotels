        ...
        <div className=" w-full block">
          <div className=" flex flex-col gap-6">
            ...
            <div className=" flex gap-4">
              ...
              <Button className=" px-3 text-sm h-7 py-0 flex items-center self-center bg-gray-300 text-black">
                Edit
              </Button>
            </div>
            {/* details */}
          ...
          <div className=" w-full block md:hidden p-5 ">
            <div className=" flex flex-col gap-6 items-center">
              ...
              <div className=" flex gap-9 justify-center flex-wrap lg:flex-nowrap ">
                ...
                {/* complete your profile */}
                <div className=" flex flex-col gap-2 min-w-[10rem]">
                  <h2 className=" text-2xl text-center font-medium tracking-tight">
                    Complete your profile
                  </h2>
...
export default AboutProfileMain;
